...
export default function Home() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Our team builds bespoke AI solutions tailored to your specific business needs and challenges.",
    },
    {
      icon: <Database className="h-10 w-10" />,
      title: "Data Engineering",
      description: "We design and implement robust data pipelines and infrastructure to power your AI initiatives.",
    },
    {
  ...
  const processSteps = [
    ...
    },
    {
      number: "03",
      title: "Development",
      description: "We build, train, and fine-tune AI models using state-of-the-art techniques and your specific data.",
    },
    {
      number: "04",
      title: "Integration",
      description: "Our engineers seamlessly integrate AI solutions into your existing systems and workflows.",
    },
    {
      number: "05",
      title: "Deployment",
    ...
    },
    {
      number: "06",
      title: "Optimization",
      description: "Continuous improvement through performance monitoring, retraining, and feature enhancement.",
    },
  ]
        ...
        <motion.div style={{ opacity, scale }} className="container mx-auto px-4 z-10 text-center">
          ...
          >
            ...
            <p className="mt-6 text-xl text-gray-300 max-w-2xl mx-auto">
              We build intelligent solutions that drive innovation, efficiency, and growth for forward-thinking
              organizations.
            </p>
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold mb-2">Cutting-Edge Expertise</h3>
                    <p className="text-gray-400">
                      Our team includes PhDs and industry veterans with experience at leading AI research labs and tech
                      companies.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      We don't believe in one-size-fits-all. Every solution we build is tailored to your specific
                      business context.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">
                      We help you leverage your data assets to create AI systems that deliver measurable business
                      outcomes.
                    </p>
                  </div>
                </div>
              ...
              <div className="aspect-square rounded-2xl bg-gradient-to-br from-purple-500/20 to-cyan-500/20 p-1">
                <div className="w-full h-full rounded-xl bg-zinc-900 p-8 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400">
                      To democratize artificial intelligence by making advanced AI capabilities accessible and
      ...
      <section id="team" className="py-24 bg-zinc-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              Brilliant minds working together to push the boundaries of what's possible with AI.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {teamMembers.map((member, index) => (
              ...
              >
                ...
                <p className="text-purple-400 text-sm mb-4 text-center">{member.role}</p>
      ...
      <section id="process" className="py-24 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">
              A systematic approach to developing AI solutions that deliver real business value.
            </p>
          </div>
            ...
            >
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-300">San Francisco • New York • London</span>
                </div>
